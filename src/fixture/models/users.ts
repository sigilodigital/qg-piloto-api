...
export const userList: UsuarioEntity[] = [
    {
        ...
        _contato: {
            ...
            _enderecoList: [
                { place: 'Alameda dos Anjos', number: '1000', description: 'Casa', zipCode: 12345678, country: 'Brasil', city: 'São Paulo', state: 'São Paulo', complement: 'Por do sol'  }
            ],
    ...
    },
    {
        ...
        _contato: {
            ...
            _enderecoList: [
                { place: 'Praça da Árvore', number: '321', description: 'Escritório', zipCode: 12345678, country: 'Brasil', city: 'São Paulo', state: 'São Paulo', complement: 'Por do sol'  }
            ],
