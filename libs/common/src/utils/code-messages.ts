export const MensagenEnum = {
    ...
    // ERROR - AUTH
    // ERROR - AUTH_USR
    ERR_AUTH_ACES_PUB_NEGADO: { text: "Acesso público negado.", code: 80},
    ERR_AUTH_USR: { text: "Perfil não tem acesso ao método solicitado.", code: 81},
    // ERROR - AUTH_SYS
    ...
    ERR_FIND_URL_INVAL: { text: "URL inválida.", code: 31},
